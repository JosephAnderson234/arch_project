...
REM
REM Generated by Vivado on Fri Oct 10 09:39:58 -0500 2025
...
echo "xvlog --incr --relax -prj tb_fpu_top_vlog.prj"
call xvlog  --incr --relax -prj tb_fpu_top_vlog.prj -log xvlog.log
