...
REM
REM Generated by Vivado on Fri Oct 10 17:25:57 -0500 2025
...
echo "xvlog --incr --relax -prj tb_fpu_addsub_vlog.prj"
call xvlog  --incr --relax -prj tb_fpu_addsub_vlog.prj -log xvlog.log
