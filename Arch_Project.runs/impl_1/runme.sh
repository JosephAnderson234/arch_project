...
HD_PWD='C:/Users/cosea/Documents/vivado/Arch_Project/Arch_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_alu_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fp_alu_top.tcl -notrace
