...
HD_PWD='C:/Users/cosea/Documents/vivado/Arch_Project/Arch_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_alu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_alu_top.tcl
